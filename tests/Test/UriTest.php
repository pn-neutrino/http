...
class UriTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @return array
     */
    private function getPartsProperty(Uri $uri)
    {
        $reflectionClass = new \ReflectionClass(Uri::class);
        $partsProperty = $reflectionClass->getProperty('parts');
        $partsProperty->setAccessible(true);

        return $partsProperty->getValue($uri);
    }
    ...
    public function testBasic($expectedParts, $url)
    {
        ...
        $parts = $this->getPartsProperty($uri);
