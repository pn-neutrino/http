...
class StreamContextStreamingTest extends TestCase
{
    public function testCall()
    {
        ...
        $streamCtxStreaming
            ...
            ->on(StreamContext\Streaming::EVENT_PROGRESS, function (StreamContext\Streaming $streamCtxStreaming, $content) use (&$whatcher) {
        ...
        $this->assertGreaterThanOrEqual($response->header->get('Content-Length'), $whatcher[StreamContext\Streaming::EVENT_PROGRESS]['length']);
